...
public class WeatherAdapter extends RecyclerView.Adapter<WeatherViewHolders> {
    ...
    public WeatherViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        WeatherViewHolders viewHolder = null;
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.weather_design, parent, false);
        viewHolder = new WeatherViewHolders(layoutView);
        return viewHolder;
    }
